...
use JoseChan\Examination\Admin\Extensions\Actions\UserExamSubjectStart;
...
class UserExaminationSubjectController extends Controller
{
    ...
    public function grid($exam_id)
    {
        return Admin::grid(ExaminationSubject::class, function (Grid $grid) use ($exam_id) {
            ...
            $grid->actions(function (Grid\Displayers\Actions $actions) {
                ...
                $actions->append(new UserExamSubjectStart($actions->getResource(), $actions->getKey()));
            });
